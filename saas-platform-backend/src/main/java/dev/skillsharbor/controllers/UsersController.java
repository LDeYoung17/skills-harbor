package dev.skillsharbor.controllers;

import dev.skillsharbor.entities.Users;
import dev.ranieri.services.UsersService;
...
@RestController// automatically appends @ResponseBody to all methods in the class.
public class BookController {
    ...
    @GetMapping("/books/{id}")
    public Users getBookById(@PathVariable int id){
